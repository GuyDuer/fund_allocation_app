...
class PortfolioManager {
    ...
    async generateAdvancedForecast() {
        ...
        const forecastYears = [2, 5, 10, 15, 20, 25, 30];
        ...
        const forecastData = forecastYears.map(targetYear => {
        ...
        this.displayAdvancedForecastResults(forecastData);
    }
    ...
    displayAdvancedForecastResults(forecastData) {
        // Update table with enhanced information
        const tableBody = document.getElementById('forecast-table-body');
        tableBody.innerHTML = forecastData.map(data => {
        ...
        // Show allocation evolution
        this.displayAllocationEvolution(forecastData);
    }
